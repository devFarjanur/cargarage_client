            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="h-full w-full flex items-center absolute  bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
                    <div className='text-white space-y-7 w-2/4 pl-20'>
                        ...
                        <div>
                            <button className="btn bg-[#FF3811] hover:bg-[#FF3811] text-white py-4 px-5 mr-5">Discover More</button>
                            <button className="btn bg-transparent hover:bg-transparent border border-white hover:border-white py-4 px-5 text-white">Latest Project</button>
                        </div>
                    </div>
